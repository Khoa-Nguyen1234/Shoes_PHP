...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($name)) {
        ...
        if (empty($id)) {
            $sql = "INSERT INTO product(name, price, amount, img, content, created_at, updated_at) 
                    VALUES ('$name', '$price', '$amount', '$img', '$content', '$created_at', '$updated_at')";
        } else {
...
<body>
    ...
    <div class="main-content">
        ...
        <main>
            <form action="add.php" method="post" class="product-form" enctype="multipart/form-data">
